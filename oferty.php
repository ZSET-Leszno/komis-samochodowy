...
<div class="filtry">
            ...
            <div class="filter">
                <h4>Model:</h4>
                <select disabled oninput="filtr('marka='+document.getElementById('filter-marka').value+'&model='+document.getElementById('filter-model').value+'&min_rok='+document.getElementById('min_rok').value+'&max_rok='+document.getElementById('max_rok').value+'&min_cena='+document.getElementById('min_cena').value+'&max_cena='+document.getElementById('max_cena').value+'&min_silnik='+document.getElementById('min_silnik').value+'&max_silnik='+document.getElementById('max_silnik').value+'&min_przebieg='+document.getElementById('min_przebieg').value+'&max_przebieg='+document.getElementById('max_przebieg').value+'&kolor='+document.getElementById('filter-kolor').value+'&stan='+document.getElementById('filter-kolor stan').value)" name="model" id="filter-model">
                    <option id='default' value="" selected disabled hidden>-Wszystkie-</option>
                </select>
            </div>
            <div class="filter">
                <h4>Cena:</h4>
                <input type="number" oninput="filtr('marka='+document.getElementById('filter-marka').value+'&model='+document.getElementById('filter-model').value+'&min_rok='+document.getElementById('min_rok').value+'&max_rok='+document.getElementById('max_rok').value+'&min_cena='+document.getElementById('min_cena').value+'&max_cena='+document.getElementById('max_cena').value+'&min_silnik='+document.getElementById('min_silnik').value+'&max_silnik='+document.getElementById('max_silnik').value+'&min_przebieg='+document.getElementById('min_przebieg').value+'&max_przebieg='+document.getElementById('max_przebieg').value+'&kolor='+document.getElementById('filter-kolor').value+'&stan='+document.getElementById('filter-kolor stan').value)" name="min_cena" id="min_cena" placeholder="OD">
            ...
            <div class="filter">
                <h4>Kolor:</h4>
                <select name="kolor" oninput="filtr('marka='+document.getElementById('filter-marka').value+'&model='+document.getElementById('filter-model').value+'&min_rok='+document.getElementById('min_rok').value+'&max_rok='+document.getElementById('max_rok').value+'&min_cena='+document.getElementById('min_cena').value+'&max_cena='+document.getElementById('max_cena').value+'&min_silnik='+document.getElementById('min_silnik').value+'&max_silnik='+document.getElementById('max_silnik').value+'&min_przebieg='+document.getElementById('min_przebieg').value+'&max_przebieg='+document.getElementById('max_przebieg').value+'&kolor='+document.getElementById('filter-kolor').value+'&stan='+document.getElementById('filter-kolor stan').value)" id="filter-kolor">
                    <option value="" selected disabled hidden>-Wszystkie-</option>
                    <option value="">Wszystkie</option>
                    <?php echo kolory();?>
                </select>
            ...
            <div class="filter">
                ...
                <select name="stan" oninput="filtr('marka='+document.getElementById('filter-marka').value+'&model='+document.getElementById('filter-model').value+'&min_rok='+document.getElementById('min_rok').value+'&max_rok='+document.getElementById('max_rok').value+'&min_cena='+document.getElementById('min_cena').value+'&max_cena='+document.getElementById('max_cena').value+'&min_silnik='+document.getElementById('min_silnik').value+'&max_silnik='+document.getElementById('max_silnik').value+'&min_przebieg='+document.getElementById('min_przebieg').value+'&max_przebieg='+document.getElementById('max_przebieg').value+'&kolor='+document.getElementById('filter-kolor').value+'&stan='+document.getElementById('filter-kolor stan').value)" id="filter-kolor stan">
                    <option value="" selected disabled hidden>-Wszystkie-</option>
                    <option value="">Wszystkie</option>
                    <?php echo stany();?>
