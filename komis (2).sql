...
--
-- Host: 127.0.0.1
-- Czas generowania: 27 Lut 2023, 13:09
...
(6, 'Audi A5 2.0 TDI Sportback Quattro DPF', 1, 5, 3, 22, 1, 87777, 2014, 1, '114000', '1968', '177', '3_1.webp;3_2.webp;3_3.webp;3_4.webp;3_5.webp', 'Samochód jest zarejestrowany i ubezpieczony w POLSCE !!!\r\nSamochód w BOGATEJ wersji wyposażeniowej !!!\r\nSamochód przygotowany do eksploatacji !!!\r\nNiniejsze ogłoszenie dotyczy samochodu\r\nAUDI A5 SPORTBACK S-LINE 2,0 TDI 177 KM + 6 BIEGÓW + QUATTRO + KOLOROWA NAVIGACJA + KLIMATRONIK x 2 + ELEKTRYKA + PARKTRONIK + TEMPOMAT + BI-XENONY + LEDY + SKÓRZANA TAPICERKA + PODGRZEWANE FOTELE !!!\r\nSAMOCHÓD PREZENTUJE SIE BARDZO DOBRZE.'),
(7, 'Peugeot 208 1.2 PureTech Style', 12, 189, 2, 24, 2, 26777, 2013, 2, '100000', '1199', '82', '4_1.webp;4_2.webp;4_3.webp;4_4.webp;4_5.webp', 'Samochód jest zarejestrowany i ubezpieczony w POLSCE !!!\r\nSamochód w BOGATEJ wersji wyposażeniowej !!!\r\nSamochód przygotowany do eksploatacji !!!\r\nNiniejsze ogłoszenie dotyczy samochodu\r\nPEUGEOT 208 1,2 VTi 72 KM + KLIMATYZACJA + ELEKTRYKA + TEMPOMAT PODGRZEWANE FOTELE !!!\r\nSAMOCHÓD PREZENTUJE SIE BARDZO DOBRZE.');
...
--
ALTER TABLE `samochody`
  MODIFY `id_samochodu` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
